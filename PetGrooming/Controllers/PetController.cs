...
namespace PetGrooming.Controllers
{
    public class PetController : Controller
    {
        ...
        //[HttpPost] Update
        [HttpPost]
        public ActionResult Update(int id, int SpeciesID, string PetName, double PetWeight, string PetColor, string PetNotes )
        {
            string query = "Update Pets set petname = @PetName, speciesid = @SpeciesID, color = @PetColor, weight = @PetWeight where PetId = @PetId";
